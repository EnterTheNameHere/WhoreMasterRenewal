...
protected:
    ...
    std::shared_ptr<CSurface> m_BackgroundSurface = nullptr;
    SDL_Surface* m_Background = nullptr;
    SDL_Surface* m_Border = nullptr;
    int m_BorderSize = 0;
    
    // for storing the scaling ratio of the interface
    float m_xRatio = 0.0;
    float m_yRatio = 0.0;
};
...
private:
    int m_Id;                // list ID
    int m_Pos = 0;           // position variable
    cInterfaceWindow& m_Win; // window reference
};
