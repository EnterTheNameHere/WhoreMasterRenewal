...
//		m_UnloadedResources[i] = nullptr;
		m_Last[i] = nullptr;
		m_ResourceCount[i] = 0;
//		m_UnloadedLast[i] = nullptr;
	}
}
...
//	m_UnloadedResources[type] = nullptr;
	m_Last[type] = nullptr;
	m_ResourceCount[type] = 0;
//	m_UnloadedLast[type] = nullptr;
}
...
//	{
		...
		else
		{
			...
			m_Resources[type]->m_Next = nullptr;
			m_Resources[type]->m_Prev = nullptr;
		}
