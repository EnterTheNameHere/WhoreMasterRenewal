...
sGirl* cGirls::GetRandomGirl(bool slave, bool catacomb)
{
...
# pragma region sex3
	...
	case 1:
		...
		break;
	case 2: OutStr += "Thor, God of Thunderfucking!!!!"; break;
	case 3:
		...
		break;
	case 4: OutStr += "the invisible something or other????"; break;
	case 5: OutStr += "the butler. (He always did it.)"; break;
	case 6:
		OutStr += "the ";
	...
	case 8:
		...
		break;
	case 9: OutStr += "the master of the hidden dick technique. (Where is it? Nobody knows.)"; break;
	case 10: OutStr += "cake. It isn't a lie!"; break;
	case 11:
	...
	case 13:
		...
		break;
	case 14: OutStr += "grandmaster piledriver the 17th."; break;
	case 15:
	...
	case 16:
		...
		if (random <= 2)
		 ...
		 break;
	case 17: OutStr += "the letter H."; break;
	case 18: OutStr += "a completely regular and unspectacular guy."; break;
	case 19:
		OutStr += "the ";
...
# pragma region group3
	...
	case 5:
		...
		break;
	case 6: OutStr += "a group of people from some place called the 'Pink Petal forums'."; break;
	case 7:
...
# pragma region bdsm3
	...
	case 3:
		...
		break;
	case 4: OutStr += "the pirate dressed as a ninja. (Cool things are cool.)"; break;
	case 5: OutStr += "Hannibal Lecter."; break;
	case 6:
		OutStr += "the stoned ";
	...
	case 7:
		...
		if (random <= 2)
			...
			break;
	case 8: OutStr += "someone who looks exactly like you!"; break;
	case 9:
		OutStr += "the horny ";
	...
	case 11:
		...
		OutStr += " from a competing brothel."; break;
	case 12: OutStr += "a cruel ";
	...
	case 14:
		...
		break;
	case 15: OutStr += "Grandpa Parkins from down the street."; break;
	case 16:
		...
		OutStr += ".";
		break;
	case 17: OutStr += "the senior member of the cult of ";
...
# pragma region beast3
	...
	case 5:
		...
		break;
	case 6: OutStr += "the swamp thing with (wait for it) swamp tentacles!"; break;
	case 7: OutStr += "the pirnja gestalt. (The revolution is coming.)"; break;
	case 8:
		OutStr += "the color ";
