...
namespace WM_Girls_Generator
{
    public partial class Form1
    {
        ...
        private void SkillTBox_02_TextChanged(object sender, EventArgs e)
        {
            LimitTextBox(SkillTBox_02);
        }

        private void SkillTBox_10_TextChanged(object sender, EventArgs e)
        {
            LimitTextBox(SkillTBox_10);
        }

        private void SkillTBox_01_TextChanged(object sender, EventArgs e)
        {
            LimitTextBox(SkillTBox_01);
        }

        private void SkillTBox_03_TextChanged(object sender, EventArgs e)
        {
            LimitTextBox(SkillTBox_03);
        }

        private void SkillTBox_04_TextChanged(object sender, EventArgs e)
        {
            LimitTextBox(SkillTBox_04);
        }

        private void SkillTBox_05_TextChanged(object sender, EventArgs e)
        {
            LimitTextBox(SkillTBox_05);
        }

        private void SkillTBox_06_TextChanged(object sender, EventArgs e)
        {
            LimitTextBox(SkillTBox_06);
        }

        private void SkillTBox_07_TextChanged(object sender, EventArgs e)
        {
            LimitTextBox(SkillTBox_07);
        }

        private void SkillTBox_08_TextChanged(object sender, EventArgs e)
        {
            LimitTextBox(SkillTBox_08);
        }

        private void SkillTBox_09_TextChanged(object sender, EventArgs e)
        {
            LimitTextBox(SkillTBox_09);
        }
